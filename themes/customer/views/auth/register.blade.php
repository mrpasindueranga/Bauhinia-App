        ...
        <div class="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-md sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <input id="contact_1" type="number"
                        class="form-input w-full @error('contact_1') border-red-500 @enderror" name="contact_1"
                        value="{{ old('contact_1') }}" required autocomplete="contact_1">
                ...
                <div class="mt-4">
                    ...
                    <input id="contact_2" type="number"
                        class="form-input w-full @error('contact_2') border-red-500 @enderror" name="contact_2"
                        value="{{ old('contact_2') }}" required autocomplete="contact_2">
