        ...
        <form action="{{ route('staff.employee.store') }}" method="POST" class="max-w-xl m-4 p-10 rounded shadow-xl"
            ...
            <div class="mt-2">
                ...
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="name"
                    type="text" required placeholder="Employee Name">
            </div>
            <div class="mt-2">
                <label class="block text-sm text-white mb-2">Employee Email</label>
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="email"
                    type="email" required placeholder="Employee Email">
            </div>
            <div class="mt-2">
                ...
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="nic"
                    type="text" required placeholder="Employee NIC">
            </div>
            <div class="mt-2">
                ...
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="contact"
                    type="number" required placeholder="Employee Contact Number">
            </div>
            <div class="mt-2">
                <label class="block text-sm text-white mb-2">Password</label>
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="password"
