...
@section('content')
    <div class="leading-loose">
        <form action="{{ route('staff.measurement.update', $Measurement->id) }}" method="POST"
            ...
            <div class="mt-4">
                ...
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="unit"
                    type="text" required placeholder="Category Name" value="{{ $Measurement->unit }}">
            </div>
            <div class="mt-4">
                ...
                <input class="w-full px-5 focus:ring-green-500 py-1 text-gray-700 bg-gray-200 rounded" name="symbol"
                    type="text" required placeholder="Measurement Symbol" value="{{ $Measurement->symbol }}">
            </div>
            <div class="mt-4">
